...
BOT_TOKEN = getenv("BOT_TOKEN", "5873512196:AAGeumkTrrXU0c4lewQtbSTWWi36fD0h0S8")
...
# mandatory vars
OWNER_USERNAME = getenv("OWNER_USERNAME", "R7_VK")
ALIVE_NAME = getenv("ALIVE_NAME", "song")
BOT_USERNAME = getenv("BOT_USERNAME", "ROSE_R7_bot")
